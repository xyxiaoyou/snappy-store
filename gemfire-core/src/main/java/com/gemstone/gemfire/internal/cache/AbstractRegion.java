                                                ...
                                                DataSerializableFixedID, RegionEntryContext
{
  ...
  public final Set<String> getGatewaySenderIds() {
    return this.gatewaySenderIds;
  }

  public final Set<String> getAsyncEventQueueIds() {
  ...
  public final Set<String> getActiveSerialGatewaySenderIds() {
  ...
  public final Set<String> getActiveSerialAsyncQueueIds() {
