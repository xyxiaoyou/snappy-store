 ...
 * @since 7.5
 */
public final class OffHeapMemoryMonitor implements ResourceMonitor,
    MemoryUsageListener {
  ...
  private void startMonitoring() {
    synchronized (this) {
      ...
      ThreadGroup group = LogWriterImpl.createThreadGroup("OffHeapMemoryMonitor Threads", (LogWriterI18n) null);
