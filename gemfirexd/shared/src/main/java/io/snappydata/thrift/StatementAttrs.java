...
public class StatementAttrs implements org.apache.thrift.TBase<StatementAttrs, StatementAttrs._Fields>, java.io.Serializable, Cloneable, Comparable<StatementAttrs> {
  ...
  private static final org.apache.thrift.protocol.TField LOCK_OWNER_FIELD_DESC = new org.apache.thrift.protocol.TField("lockOwner", org.apache.thrift.protocol.TType.STRING, (short)24);
  ...
  public String lockOwner; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.LOCK_OWNER, new org.apache.thrift.meta_data.FieldMetaData("lockOwner", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public StatementAttrs setLockOwner(String lockOwner) {
    this.lockOwner = lockOwner;
    return this;
  }

  public void unsetLockOwner() {
    this.lockOwner = null;
  }

  /** Returns true if field lockOwner is set (has been assigned a value) and false otherwise */
  public boolean isSetLockOwner() {
    return this.lockOwner != null;
  }

  public void setLockOwnerIsSet(boolean value) {
    if (!value) {
      this.lockOwner = null;
    }
  }
  ...
  public boolean equals(StatementAttrs that) {
    ...
    boolean this_present_lockOwner = true && this.isSetLockOwner();
    boolean that_present_lockOwner = true && that.isSetLockOwner();
    if (this_present_lockOwner || that_present_lockOwner) {
      if (!(this_present_lockOwner && that_present_lockOwner))
        return false;
  ...
  public int hashCode() {
    ...
    boolean present_lockOwner = true && (isSetLockOwner());
    list.add(present_lockOwner);
    if (present_lockOwner)
      list.add(lockOwner);
  ...
  public int compareTo(StatementAttrs other) {
    ...
    lastComparison = Boolean.valueOf(isSetLockOwner()).compareTo(other.isSetLockOwner());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLockOwner()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.lockOwner, other.lockOwner);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class StatementAttrsStandardScheme extends StandardScheme<StatementAttrs> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, StatementAttrs struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 24: // LOCK_OWNER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.lockOwner = iprot.readString();
              struct.setLockOwnerIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StatementAttrs struct) throws org.apache.thrift.TException {
      ...
      if (struct.lockOwner != null) {
        if (struct.isSetLockOwner()) {
          oprot.writeFieldBegin(LOCK_OWNER_FIELD_DESC);
          oprot.writeString(struct.lockOwner);
          oprot.writeFieldEnd();
        }
      }
