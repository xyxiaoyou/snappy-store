              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.serverTypes = new HashSet<ServerType>(2*_set480.size);
                  ServerType _elem481;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.serverGroups = new HashSet<String>(2*_set483.size);
                  String _elem484;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.failedServers = new HashSet<HostAddress>(2*_set486.size);
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.serverTypes = new HashSet<ServerType>(2*_set495.size);
            ServerType _elem496;
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.serverGroups = new HashSet<String>(2*_set498.size);
            String _elem499;
        ...
        if (incoming.get(2)) {
          {
            ...
            struct.failedServers = new HashSet<HostAddress>(2*_set501.size);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.serverTypes = new HashSet<ServerType>(2*_set504.size);
                  ServerType _elem505;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.serverGroups = new HashSet<String>(2*_set507.size);
                  String _elem508;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.failedServers = new HashSet<HostAddress>(2*_set510.size);
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.serverTypes = new HashSet<ServerType>(2*_set519.size);
            ServerType _elem520;
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.serverGroups = new HashSet<String>(2*_set522.size);
            String _elem523;
        ...
        if (incoming.get(2)) {
          {
            ...
            struct.failedServers = new HashSet<HostAddress>(2*_set525.size);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<HostAddress>(_list528.size);
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<HostAddress>(_list533.size);
