            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.properties = new ArrayList<Map<String,String>>(_list423.size);
                Map<String,String> _elem424;
                for (int _i425 = 0; _i425 < _list423.size; ++_i425)
                {
                  {
                    org.apache.thrift.protocol.TMap _map426 = iprot.readMapBegin();
                    _elem424 = new HashMap<String,String>(2*_map426.size);
                    String _key427;
                    String _val428;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.newProperties = new ArrayList<Map<String,String>>(_list430.size);
                Map<String,String> _elem431;
                for (int _i432 = 0; _i432 < _list430.size; ++_i432)
                {
                  {
                    org.apache.thrift.protocol.TMap _map433 = iprot.readMapBegin();
                    _elem431 = new HashMap<String,String>(2*_map433.size);
                    String _key434;
                    String _val435;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.otherFlags = new ArrayList<Integer>(_list437.size);
                int _elem438;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.catalogPartitions = new ArrayList<CatalogPartitionObject>(_list440.size);
      ...
      if (struct.properties != null) {
        if (struct.isSetProperties()) {
          oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
          {
            ...
            for (Map<String,String> _iter444 : struct.properties)
            {
              {
                ...
                for (Map.Entry<String, String> _iter445 : _iter444.entrySet())
                {
      ...
      if (struct.newProperties != null) {
        if (struct.isSetNewProperties()) {
          oprot.writeFieldBegin(NEW_PROPERTIES_FIELD_DESC);
          {
            ...
            for (Map<String,String> _iter446 : struct.newProperties)
            {
              {
                ...
                for (Map.Entry<String, String> _iter447 : _iter446.entrySet())
                {
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (Map<String,String> _iter451 : struct.properties)
          {
            {
              oprot.writeI32(_iter451.size());
              for (Map.Entry<String, String> _iter452 : _iter451.entrySet())
              {
      ...
      if (struct.isSetNewProperties()) {
        {
          ...
          for (Map<String,String> _iter453 : struct.newProperties)
          {
            {
              oprot.writeI32(_iter453.size());
              for (Map.Entry<String, String> _iter454 : _iter453.entrySet())
              {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.names = new ArrayList<String>(_list457.size);
          String _elem458;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.properties = new ArrayList<Map<String,String>>(_list460.size);
          Map<String,String> _elem461;
          ...
          {
            {
              ...
              _elem461 = new HashMap<String,String>(2*_map463.size);
              String _key464;
              String _val465;
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.newProperties = new ArrayList<Map<String,String>>(_list467.size);
          Map<String,String> _elem468;
          ...
          {
            {
              ...
              _elem468 = new HashMap<String,String>(2*_map470.size);
              String _key471;
              String _val472;
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.otherFlags = new ArrayList<Integer>(_list474.size);
          int _elem475;
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.catalogPartitions = new ArrayList<CatalogPartitionObject>(_list477.size);
