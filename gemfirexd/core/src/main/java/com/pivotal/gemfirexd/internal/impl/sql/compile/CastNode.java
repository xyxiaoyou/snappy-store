/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.CastNode
...
// GemStone changes BEGIN
				// changed to Byte.valueOf()
				constantObject = Byte.valueOf(constantValue.getByte());
				/* (original code)
...
// GemStone changes END
	...
	protected boolean isEquivalent(ValueNode o) throws StandardException
	{
           ...
           throws StandardException 
        {
            ...
            castOperand = castOperand.genExpressionOperands(outerResultColumns 
                                                           ,null
                                                           ,remapToNew);
            return this;
        }
        ...
        {
          return "CAST "+castOperand.printExplainInfo() + " AS " + getTypeServices().getTypeName();
        }

        @Override
        public String ncjGenerateSql() {
          String sql = castOperand.ncjGenerateSql();
          if (sql == null) {
            return null;
          }
