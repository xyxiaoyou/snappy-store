/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.types.BigIntegerDecimal
...
public final class BigIntegerDecimal extends BinaryDecimal
{
	...
	/**
	 * Negate the number.
	 * @see com.pivotal.gemfirexd.internal.iapi.types.NumberDataValue#minus(com.pivotal.gemfirexd.internal.iapi.types.NumberDataValue)
	 */
	...
	/* (non-Javadoc)
	 * @see com.pivotal.gemfirexd.internal.iapi.types.VariableSizeDataValue#setWidth(int, int, boolean)
	 */
