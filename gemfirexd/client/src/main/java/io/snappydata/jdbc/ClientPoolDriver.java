...
public class ClientPoolDriver implements Driver {
  ...
  public Connection connect(String url, Properties properties) throws SQLException {
    ...
    properties.setProperty(JDBCConnectionTable.PoolProps.URL.key,
        clientDriverURL);
    
    try {
      // to enable commons-pool implementation
      return JDBCConnectionTable.create().getConnection(properties);
    } catch (Exception e) {
