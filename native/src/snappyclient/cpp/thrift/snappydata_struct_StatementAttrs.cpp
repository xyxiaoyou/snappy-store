...
void StatementAttrs::__set_lockOwner(const std::string& val) {
  this->lockOwner = val;
__isset.lockOwner = true;
}
...
uint32_t StatementAttrs::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 23:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->lockOwner);
          this->__isset.lockOwner = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t StatementAttrs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.lockOwner) {
    xfer += oprot->writeFieldBegin("lockOwner", ::apache::thrift::protocol::T_STRING, 23);
    xfer += oprot->writeString(this->lockOwner);
    xfer += oprot->writeFieldEnd();
  }
...
StatementAttrs::StatementAttrs( StatementAttrs&& other182) noexcept {
  ...
  lockOwner = std::move(other182.lockOwner);
...
StatementAttrs& StatementAttrs::operator=(StatementAttrs&& other184) noexcept {
  ...
  lockOwner = std::move(other184.lockOwner);
...
void StatementAttrs::printTo(std::ostream& out) const {
  ...
  out << ", " << "lockOwner="; (__isset.lockOwner ? (out << to_string(lockOwner)) : (out << "<null>"));
  out << ")";
}
